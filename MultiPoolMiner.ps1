...
while ($true) {
    ...
    $Miners | Where-Object {$_.Profit -ge 1E-5 -or $_.Profit -eq $null} | Sort-Object -Descending Type, Profit_Bias | Format-Table -GroupBy Type (
        ...
        @{Label = "m$($Config.Currency | Select-Object -Index 0)/Day"; Expression = {if ($_.Profit) {ConvertTo-LocalCurrency $($_.Profit *1000) $($Rates.$($Config.Currency | Select-Object -Index 0)) -Offset 6} else {"Unknown"}}; Align = "right"},
