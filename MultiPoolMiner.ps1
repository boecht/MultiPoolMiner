...
while ($true) {
    ...
    $Miners | Where-Object {$_.Profit -ge 1E-5 -or $_.Profit -eq $null} | Sort-Object -Descending Type, Profit_Bias | Format-Table (
        ...
        @{Label = "Unbiased"; Expression = {if ($_.Profit_Unbias) {ConvertTo-LocalCurrency $($_.Profit_Unbias *1000) $($Rates.$($Config.Currency | Select-Object -Index 0)) -Offset 7} else {"Unknown"}}; Align = "right"},
    ...
    $ActiveMiners | Where-Object {$_.GetActivateCount() -gt 0} | Sort-Object -Descending {$_.GetStatus()},{$_.GetActiveTime()} | Format-Table -Wrap (
