...
while ($true) {
    ...
    $ActiveMiners | Where-Object {$_.GetActivateCount() -GT 0} | Sort-Object -Property @{Expression = {$_.GetStatus()}; Descending = $false}, @{Expression = {$_.GetActiveLast()}; Descending = $true} | Format-Table -Wrap (
