...
$Commands = [PSCustomObject]@{
    ...
    #"hsr" = "" #use to mine HshareCcminerAlexis           X11evo                                  108,77 MH/s    1,063         85 %  0,471             0,009776 Zpool-1
    "jackpot" = "" #JHA v8
    ...
    "monero" = "" #XMR cryptonight (v7)   <<< FireiceNvidia < XmrigNvidia < CcminerAllium
    ...
    #"x11evo" = "" #Permuted x11 (Revolver)   <<< CcminerNanashi < CcminerSkunk < CcminerTpruvot < CcminerAllium < CcminerSuprMiner < CcminerLyra2z < CcminerNevermore < CcminerSib < CcminerAlexis
    #"x11" = "" #X11 (DarkCoin)
    #"x12" = "" #X12 (GalaxyCash)
    #"x13" = "" #X13 (MaruCoin)
    #"x14" = "" #X14
